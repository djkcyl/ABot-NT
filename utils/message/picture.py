...
class SelfPicture:
    ...
    async def from_data(self, data: bytes | BytesIO, format: str | None = None) -> Picture:
        ...
        elif ctx.scene.path_without_land in ["guild.channel", "guild.user"]:
