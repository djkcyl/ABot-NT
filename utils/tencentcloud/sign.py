...
def sign_normal(secret_key: str, sign_str: str, sign_method: str) -> str:
    ...
    if sign_method == "HmacSHA256":
        ...
        msg = "signMethod only support (HmacSHA1, HmacSHA256)"
...
def sign_tc3(secret_key: str, date: str, service: str, str2sign: str) -> str:
    def _hmac_sha256(key: bytes, msg: str) -> hmac.HMAC:
        return hmac.new(key, msg.encode("utf-8"), hashlib.sha256)

    def _get_signature_key(key: str, _date: str, _service: str) -> bytes:
...
def get_tc3_signature(secret_key: str, req: Request, date: str, service: str) -> str:
    canonical_uri = "/"
...
def signature(
    ...
    if req.method == "GET" and content_type == _multipart_content:
        msg = "Invalid request method GET for multipart."
        raise ValueError(msg)
